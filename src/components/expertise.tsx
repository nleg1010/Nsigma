...
export default function Expertise({data}:any) {
    return (
        <section className='py-16 relative' id="expertise">
            ...
            <Image src="/images/abstract1.png" alt='abstract1' width={121} height={321} className='absolute right-4 -z-0 w-20 md:w-[121px] top-0  hidden md:block' />
            ...
            <Image src="/images/abstract2.png" alt='abstract2' width={121} height={321} className='absolute left-4 -bottom-20 -z-0 w-20 md:w-[121px] hidden md:block' />
        </section>
    )
}
